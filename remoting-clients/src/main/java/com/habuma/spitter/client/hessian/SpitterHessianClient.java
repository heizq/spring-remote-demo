package com.habuma.spitter.client.hessian;
 ...
 */
public class SpitterHessianClient {
    ...
    public static void main(String[] args) {
        ApplicationContext ctx = new ClassPathXmlApplicationContext("hessian-client-context.xml");
